...
public class Truck extends Machine implements Operator {
    @Override
    public void gas() {
    ...
    @Override
    public void turn() {
        System.out.println("Оператор это Урал 1982 года выпуска. Ты не волнуйся, здесь все также как и на тракторе. Все жестко и весело. Удачи");
}
